...
export function CinematicHero({ hero }: CinematicHeroProps) {
  return (
    <section
      ...
      className="hero-section relative isolate flex min-h-[min(100vh,1200px)] w-full flex-col justify-end overflow-hidden pb-16 pt-28 sm:pb-20 sm:pt-32 lg:pb-28"
    >
