...
export default async function DashboardSeoPage() {
  ...
  return (
    <>
      <DashboardPageHeader
        title="SEO"
        description="Meta-Informationen pro Pfad (site_seo). Die Startseite „/“ steuert auch die Index-Metadaten."
      />
      ...
      <div className="px-4 pb-6 pt-2 sm:px-8 lg:px-10">
        <div className="max-w-2xl rounded-2xl border border-[var(--border)] bg-[color-mix(in_oklab,var(--surface-elevated)_85%,transparent)] p-6">
          ...
          <form action={saveHomeSeo} className="mt-4 space-y-4">
            <div>
              <label className={labelClass} htmlFor="seo_title">Titel</label>
              <input
            ...
            <div>
              <label className={labelClass} htmlFor="seo_description">Beschreibung</label>
              <textarea
            ...
            <div>
              <label className={labelClass} htmlFor="seo_ogImageUrl">OG-Bild-URL (optional)</label>
              <input
                className={inputClass}
                id="seo_ogImageUrl"
                name="seo_ogImageUrl"
