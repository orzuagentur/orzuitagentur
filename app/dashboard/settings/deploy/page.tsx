...
import {
  SETTINGS_DOMAINS_PATH,
  SETTINGS_DEPLOY_PATH,
...
export default async function DashboardSettingsDeployPage() {
  const data = await getDeployPanelData();

  return (
    <SettingsSubPage pathname={SETTINGS_DEPLOY_PATH}>
